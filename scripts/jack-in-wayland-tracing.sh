...
SERVICE="$VR/monado-service-tracing" # tracing build (docs/50); comm truncates
                                      # to "monado-service-" so pgrep -x
                                      # monado-service never matches it
LOG="$VR/jack-in-wayland-tracing.log" # separate from the production log on purpose
